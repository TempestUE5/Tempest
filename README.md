...
Tempest is a game developed by [Daniel Gerhardt](https://github.com/danieljgerhardt) and [Amy Liu](https://github.com/mialana). It was created in UE5 in a little under a month, and features usage of the Unreal [Gameplay Ability System](https://dev.epicgames.com/documentation/en-us/unreal-engine/gameplay-ability-system-for-unreal-engine) and [Niagara Particle Simulation](https://dev.epicgames.com/documentation/en-us/unreal-engine/overview-of-niagara-effects-for-unreal-engine) to build game systems and mechanics.
